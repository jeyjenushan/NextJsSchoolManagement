  ...
  return (
    <div className="flex items-center justify-between p-4">
        ...
        <div className="bg-white rounded-full w-7 h-7
            ...
            <div className="absolute -top-3 -right-5 w-5 h-5 flex justify-center items-cente bg-purple-500 text-white rounded-full text-xs">
                3
                </div>     
            ...
            <div className="flex flex-col">
                <span className="text-xs leading-3 font-medium">Jenushan</span>
